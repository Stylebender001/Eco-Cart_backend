  ...
  return (
    <div className="fixed z-50 bottom-6 right-6">
      {!isOpen ? (
        ...
        <form className="bg-white border h-[72vh] shadow-xl w-96 rounded-xl border-green-800/10">
          ...
          <div className="w-full h-[50vh] px-6 py-6 overflow-y-scroll border-b border-b-green-800/20 scroll-auto">
          ...
          <div className="flex items-center justify-center gap-3 px-6 py-4">
            ...
            />
            <div className="flex items-center justify-center p-3 text-white rounded-full bg-green-800/80">
